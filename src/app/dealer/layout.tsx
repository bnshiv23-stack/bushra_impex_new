...
export const metadata: Metadata = {
  ...
  description:
    "Join the X1 Power dealer network by Bushra Impex. 1300+ authorised dealers across all 29 Indian states. FMTTI-tested agricultural machinery, government subsidy approved. Apply to become a dealer today.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Join 1300+ X1 Power dealers across India. Premium agricultural machinery, government subsidy support, marketing materials, and technical training provided.",
